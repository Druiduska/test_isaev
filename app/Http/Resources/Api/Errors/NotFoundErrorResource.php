...
/**
 * @OA\Schema(
 *     schema="NotFoundErrorResource",
 *
 *      @OA\Property(property="result", type="string", example="NOT_FOUND", description="Slug ошибки"),
 ...
 * )
 */
class NotFoundErrorResource extends AbstractErrorResource
{
    public const RESULT = Slug::NOT_FOUND;
}
