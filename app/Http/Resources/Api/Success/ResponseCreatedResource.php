...
/**
 * @OA\Schema(
 *     schema="ResponseCreatedResource",
 *
 *      @OA\Property(property="result", type="string", example="CREATED", description="Slug Ответа"),
 ...
 * )
 */
class ResponseCreatedResource extends AbstractSuccessResource
{
    public const RESULT = Slag::CREATED;
}
