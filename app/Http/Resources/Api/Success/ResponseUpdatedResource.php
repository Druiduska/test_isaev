...
/**
 * @OA\Schema(
 *     schema="ResponseUpdatedResource",
 *
 *      @OA\Property(property="result", type="string", example="UPDATED", description="Slug Ответа"),
 ...
 * )
 */
class ResponseUpdatedResource extends AbstractSuccessResource
{
    public const RESULT = Slag::UPDATED;
}
